...
public class UsersController : ControllerBase
{
    ...
    public UsersController(CRMService crmService, IRdaUnitOfWork unitOfWork, IHttpClientFactory httpClientFactory, IUserIdentityService identityService)
    {
    ...
    public async Task<IActionResult> GetListaUsuarios()
    {
        ...
        var topeJerarquia = _userIdentityService.ListarRolesSuperiores(User)
            .Max(x => x.jerarquia);
